...
fn generate_bindings_dynamic() {
    ...
    //   bindgen headers/minisat.h -o _bindings-minisat.rs --dynamic-loading minisat --default-alias-style new_type --with-derive-eq --blocklist-type minisat_bool --blocklist-item minisat_l_.*
}
