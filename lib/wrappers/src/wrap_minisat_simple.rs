...
pub struct MiniSatSimpleSolver {
    inner: MiniSat,
    assumptions: Vec<MiniSatLit>,
}

impl MiniSatSimpleSolver {
    pub fn new() -> Self {
...
impl Default for MiniSatSimpleSolver {
    fn default() -> Self {
        MiniSatSimpleSolver::new()
    }
}

impl From<MiniSat> for MiniSatSimpleSolver {
    fn from(inner: MiniSat) -> Self {
        MiniSatSimpleSolver::new_custom(inner)
    }
}

impl Display for MiniSatSimpleSolver {
...
impl SimpleSolver for MiniSatSimpleSolver {
...
mod tests {
    ...
    fn test_wrap_minisat() -> color_eyre::Result<()> {
        let mut solver = MiniSatSimpleSolver::new();
